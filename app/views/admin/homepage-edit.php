...
<section class="homepage-context">
    ...
    <h3 class="click2edit"><?php echo html_entity_decode($contentById[1]); ?></h3>
</section>
...
<div class="homepage-history">
    ...
    <div id="homepage-history-text">
        ...
        <h3 class="click2edit"><?php echo html_entity_decode($contentById[2]); ?></h3>
    </div>
...
<section class="homepage-food">
    <div>
        ...
        <h3 class="click2edit"><?php echo html_entity_decode($contentById[3]); ?></h3>
    </div>
...
<div class="music-grid">
    <section class="homepage-music">
        ...
        <h3 class="click2edit"><?php echo html_entity_decode($contentById[4]); ?></h3>
    </section>
    ...
    <section class="homepage-theatre">
        ...
        <h3 class="click2edit"><?php echo html_entity_decode($contentById[5]); ?></h3>
    </section>
    ...
    <section class="homepage-museums">
        ...
        <h3 class="click2edit"><?php echo html_entity_decode($contentById[6]); ?></h3>
    </section>
</div>
<?php
