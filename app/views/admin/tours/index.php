...
<script>
    ...
    function load(tourInput) {
        ...
        tdStartTime.innerHTML = tourInput.starttime;

        tdEndTime = document.createElement("td");
        tdEndTime.innerHTML = tourInput.endtime;
        ...
        rDelete.onclick = function() {
            deleteRestaurant(tourInput.id);
        };
        tdButtons.append(rEdit, rDelete);
        tr.append(tdId, tdDate, tdStartTime, tdEndTime, tdSeats, tdPrice, tdLanguage);
